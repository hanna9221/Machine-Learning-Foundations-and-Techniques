...
for i in range(times):
    ...
    for root in roots:
        E_in_gt += dt_errorRate(root, trainSet)
print('avg_E_in =', E_in/times, ', avg_E_out =', E_out/times)
print('avg_E_in_gt =', E_in_gt/(times*300))

# The result may be slightly different:
# avg_E_in = 0.0 , avg_E_out = 0.075
# avg_E_in_gt = 0.05289999999999999